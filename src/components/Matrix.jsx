...
const Matrix = ({ currentMatrix }) => {
  ...
  return (  
    <div className="flex flex-col items-center justify-start gap-5 px-10 h-[85vh]">
      <h1 className='text-3xl font-bold text-slate-500 max-w-[800px] drop-shadow mt-5'> {currentMatrix.name}</h1>
      <CreateTask 
